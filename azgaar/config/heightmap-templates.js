...
export const heightmapTemplates = (function () {
  ...
  const fractious = `Hill 12-15 50-80 5-95 5-95
    ...
    Mask 3 0 0 0
    Add -20 30-100 0 0
    Range 8-12 40-50 5-95 10-90`;

  const manyIslands = `Hill 14 20-25 10-90 10-90
    Pit 12 20-40 10-90 10-90
    Trough 18 20-35 5-95 5-95
    Strait 2 vertical 0 0
    Strait 2 horizontal 0 0`;
  ...
  return {
    ...
    manyIslands: {id: 4, name: "Many Islands", template: manyIslands, probability: 5},
  };
})();
