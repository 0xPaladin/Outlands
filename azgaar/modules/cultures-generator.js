...
import {rn,rw,rand,P,minmax,biased,getColors,abbreviate} from "../utils/index.js"

import {seed,pack,grid,biomesData,nameBases,power,neutralRate, cultures as culturesInput,culture as culturesSet} from "../main.js"

export const Cultures = (function () {
  let cells;
  ...
  const generate = function () {
    ...
    let count = Math.min(culturesInput, culturesSet[1]);
    ...
    function placeCenter(sortingFn) {
      let spacing = (grid.w + grid.h) / 2 / count;
    ...
    function defineCultureExpansionism(type) {
      ...
      return rn(((Math.random() * power) / 2 + 1) * base, 1);
    }
