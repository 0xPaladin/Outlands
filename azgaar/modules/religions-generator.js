...
import {rw,ra,rand,gauss,getMixedColor,trimVowels,getAdjective,abbreviate,each} from "../utils/index.js"

import {Names} from "./names-generator.js"

import {grid,pack,biomesData,nameBases,neutralRate as neutralInput,religions as religionsInput} from "../main.js"

export const Religions = (function () {
  ...
  function generate() {
    ...
    const organizedReligions = generateOrganizedReligions(religionsInput, lockedReligions);
  ...
  function generateOrganizedReligions(desiredReligionNumber, lockedReligions) {
    ...
    function placeReligions() {
      ...
      const spacing = (grid.w + grid.h) / 2 / desiredReligionNumber;
      ...
      console.warn(`Placed only ${religionCells.length} of ${requiredReligionsNumber} religions`);
  ...
  function expandReligions(religions) {
    ...
    const maxExpansionCost = (cells.i.length / 20) * neutralInput; // limit cost for organized religions growth
