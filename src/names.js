...
const ByTerrain = {
  "island" : ['Sea','Island','Atoll','Sound'],
  "costal" : ['Sea','Bay','Downs','Reach','Slough', 'Sound'],
  "lake" : ['Lake'],
  "desert": ['Desert', 'Dunes', 'Expanse', 'Flats', 'Hills', 'Sands','Scarps', 'Waste', 'Wasteland'],
  "badlands": ['Bluffs', 'Desert', 'Expanse', 'Flats','Plains', 'Scarps', 'Steppe', 'Waste', 'Wasteland'],
  "wetland" : ['Bog', 'Fen', 'Heath', 'Lowland', 'Marsh', 'Moor', 'Morass', 'Quagmire', 'Slough', 'Swamp', 'Waste'],
  "forest" :['Expanse', 'Forest', 'Groves', 'Hollows', 'Jungle', 'March', 'Thicket', 'Woods'],
  "plains" : ['Expanse', 'Flats', 'Heath', 'Lowland', 'March', 'Meadows', 'Moor', 'Plains', 'Prairie', 'Savanna', 'Sweep', 'Veldt'],
  "highlands" : ['Expanse', 'Flats', 'Heights', 'Reach', 'Plains', 'Steppe', 'Upland'],
  "mountains" : ['Cliffs', 'Expanse', 'Foothills', 'Heights', 'Mountains', 'Peaks', 'Range', 'Reach', 'Scarps','Teeth', 'Upland', 'Wall'],
}
